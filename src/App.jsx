...
//         {hasStarted && (
//           <Card
//           className="h-full w-[60%] shadow-lg flex flex-col"
//            >
//             <CardHeader>
...
//                   {showPreview
//                     ? "Final Preview"
//                     : `Section ${currentStep + 1} Response`}
//                 </CardTitle>
//                 {showPreview && (
...
//     doc.setFontSize(16);
//     doc.text(`Section ${index + 1}`, 40, y);
//     y += 20;

//     // Render the rich HTML content
...
//       x: 40,
//       y: y,
//       width: 520, // fit content to page width
//       windowWidth: 800,
//       autoPaging: "text",
...
//     y += 60; // spacing before next section
//   });
// };
